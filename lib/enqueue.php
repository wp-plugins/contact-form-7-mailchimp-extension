...
function wpcf7_mche_admin_enqueue_scripts () {
	global $plugin_page;
	...
	wp_enqueue_style( 'wpcf7-spartan-admin',
		wpcf7_mch_spartan_plugin_url( '../assets/css/style-spartan.css' ),
		array(), WPCF7_SPARTAN_VERSION, 'all' );

	wp_enqueue_script( 'wpcf7-spartan-admin',
		wpcf7_mch_spartan_plugin_url( '../assets/js/scripts-spartan.js' ),
